...
def cmd_parser():
    ...
    run.add_argument("-t", "--threads", type=int, metavar="", default=6,
                        help="number of cpu threads [default: 6]")
    run.add_argument("-l", "--log", type=str, metavar="",
                        help="log file path, if it's not provided the logs are"
                        " display in the stdout")
    run.add_argument("--end", type=str, choices=["pocket", "modeling",
                                                    "alignment", "clustering",
                                                    "logo"],
                        default="logo",
                        help="indicates at which step to stop [default: logo]")
    input_opt = run.add_argument_group("Reference Structures options")
    ...
    input_opt.add_argument("--chain", type=str, metavar="", default="all",
                           ...
                           "[default: all]")
    targts_opt = run.add_argument_group("Targets options",
    ...
    dbscan_opt = run.add_argument_group("Clustering options")
    ...
    extract_aa.add_argument("-p", "--position", type=int, metavar="", required=True,
                            help="position where to find the specified amino"
                            " acid type, e.g: 5")
    extract_aa.add_argument("-a", "--aa-type", type=str, metavar="", required=True ,
                            help="amino acid type to search, must be either "
                            "1-letter amino acid, 'aromatic', 'acidic', 'basic'"
